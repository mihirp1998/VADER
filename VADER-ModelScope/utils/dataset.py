...
class ImageDataset(Dataset):
    def __init__(
        ...
        base_height: int = 256,
        use_caption:     bool = False,
        image_dir: str = '/projects/katefgroup/datasets/ImageNet/train/n02099712',
        ...
        **kwargs
        ...
        self.tokenizer = tokenizer
        # st()
        self.img_types = (".png", ".jpg", ".jpeg", '.bmp',".JPEG")
        self.use_bucketing = use_bucketing
        # st()
        if ".jpg" in image_dir[0] or ".png" in image_dir[0]:
    ...
    def get_images_list(self, image_dirs):
        # st()
        full_img_dir = []
